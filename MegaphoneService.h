...
extern "C" {
    ...
    // 上传音频文件
    MEGAPHONESERVICE_API BOOL MegaphoneService_UploadFile(LPCWSTR filePath, LPWSTR errorMessage, DWORD errorSize);
    // 获取音频文件
    MEGAPHONESERVICE_API void MegaphoneService_GetFileList();
    // 删除音频文件
    MEGAPHONESERVICE_API void MegaphoneService_DelFile();
    // 播放音频文件
